...
@Document(collection = "bb_admin_panel_kirana_custom_groups")
public class KiranaCustomGroupDto {

	@Transient
    public static final String kiranaCG_sequence = "kiranaCG_sequence";
	@Id
	public String _id;
	@Field("id")
    private String id;
