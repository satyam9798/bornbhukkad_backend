...
public class RestaurantServiceImpl implements RestaurantService {
	...
	public List<Object> getProductsByVendorId(String vendorId) {
		...
		String query4 = "{$lookup: {from: 'bb_admin_panel_vendors_products',localField: 'id',foreignField: 'vendorId',pipeline: [{$project: {'_id': 0,'id':1,'descriptor':1,'tags':1,'price':1,'category_id':1,'category_ids':1, 'parent_category_id':1, 'dimension':1,'packagingPrice':1,'isActive':1,'timing':1,'weight':1, '@ondc/org/time_to_ship':1,'@ondc/org/available_on_cod':1, 'ondc_org_returnable': '$@ondc/org/returnable', 'ondc_org_cancellable': '$@ondc/org/cancellable', 'ondc_org_return_window': '$@ondc/org/return_window', 'ondc_org_seller_pickup_return': '$@ondc/org/seller_pickup_return', 'ondc_org_contact_details_consumer_care': '$@ondc/org/contact_details_consumer_care'  } }], as: 'product'}},";
